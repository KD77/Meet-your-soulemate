...
declare const _default: (routes: import("react-navigation").NavigationRouteConfigMap<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<import("react-navigation").NavigationParams>, import("react-navigation").NavigationParams>>, config: NavigationBottomTabOptions) => React.ComponentType<Pick<Props, "navigation" | "screenProps" | "descriptors" | "getAccessibilityRole" | "getAccessibilityStates" | "lazy" | "tabBarComponent" | "tabBarOptions"> & {
